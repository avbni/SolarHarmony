...
monthly_avg_efficiency = combined_filtered_df.groupby(combined_filtered_df['Datetime'].dt.month)['Efficiency'].mean()

# Plotting average efficiency for each month
plt.plot(monthly_avg_efficiency.index, monthly_avg_efficiency.values, marker='o', linestyle='-', color='green', label='Monthly Average Efficiency')

# Add title and labels
plt.title(f'Monthly Average Efficiency Over Years for Latitude {latitude}, Longitude {longitude}')
plt.xlabel('Month')
